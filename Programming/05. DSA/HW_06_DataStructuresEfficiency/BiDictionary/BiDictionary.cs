...
namespace BiDictionary
{
    class BiDictionary<K1, K2, V>
    {
        ...
        private readonly MultiDictionary<int, V> bothKeysDictionary;
        private readonly MultiDictionary<K1, K2> firstSecondKeyDictionary;
        private readonly MultiDictionary<K2, K1> secondFirstKeyDictionary;
